...
public class ProcedureDetailFragment extends android.support.v4.app.Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        rootView=inflater.inflate(R.layout.activity_procedure_detail,container,false);

        expandable_list_view = (ExpandableListView) rootView.findViewById(R.id.expandable_list_view);
        prepareData();
        expandable_list_adapter = new ProcedureDetailExpandableListAdapter(getActivity(), listHeading, listMap);
